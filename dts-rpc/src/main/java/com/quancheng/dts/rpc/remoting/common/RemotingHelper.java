 ...
 */
package com.quancheng.dts.rpc.remoting.common;
...
public class RemotingHelper {
    public static final String DTS_REMOTING = "DtsRemoting";
    public static final String DEFAULT_CHARSET = "UTF-8";

    private static final Logger log = LoggerFactory.getLogger(DTS_REMOTING);

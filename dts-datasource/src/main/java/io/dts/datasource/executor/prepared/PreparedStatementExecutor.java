...
public final class PreparedStatementExecutor {
    ...
    public ResultSet executeQuery() throws Exception {
        return executorEngine.executePreparedStatement(preparedStatementUnit, parameters, new ExecuteCallback<ResultSet>() {
    ...
    public int executeUpdate() throws Exception {
        Integer results = executorEngine.executePreparedStatement(preparedStatementUnit, parameters, new ExecuteCallback<Integer>() {
    ...
    public boolean execute() throws Exception {
        Boolean result = executorEngine.executePreparedStatement(preparedStatementUnit, parameters, new ExecuteCallback<Boolean>() {
